...
서울 건축물대장 기반 재개발 후보 동(**노후도 60%↑·건물 30개↑ = 249개**) + 실제 진행중 주거 정비사업(840곳)을 지도에서 탐색하는 정적 웹앱. 백엔드 없음.
※ 노후도 60% 미만·건물 30개 미만(공원·기지·도심 오피스 등) 동은 후보에서 제외.
...
- **⭐ 별표** — 노후도 70%↑인데 진행중 프로젝트가 없는 동(미지정 발굴 기회)
- **🏗️ 주거단지 재개발·재건축 레이어** — 추진중 **840곳**. 5단계(초기→조합설립→사업시행→관리처분→착공/준공) 색상 오버레이. 카테고리 **전체 / 🏢재건축(327) / 🏠재개발(308) / 🏘️모아타운(205)**. 점 클릭 시 구역 상세패널. 모아타운은 청록 테두리
  - ⚠️ `재개발(도시정비형)`은 도심상업 아님 — 역세권 장기전세·공공재개발·재정비촉진 등 대부분 주거라 재개발에 포함
