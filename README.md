...
- **🏗️ 주거단지 재개발·재건축 레이어** — **주거단지로 재개발/재건축 추진중인 708곳만** (도심상업·도시정비형 132곳 제외). 5단계(초기→조합설립→사업시행→관리처분→착공/준공) 색상 오버레이. 카테고리 필터 **전체 / 🏢재건축(327) / 🏠재개발(176) / 🏘️모아타운(205)**. 모아타운은 청록 테두리로 구분
